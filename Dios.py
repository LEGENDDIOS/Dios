...
\033[1;92mAuthor \033[1;93m: DIOS

\033[1;92mFb \033[1;93m: VAMOS CON DIOS

\033[1;92mWhatsapp \033[1;93m: 9866134586
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100077334375427')
...
def login():
    ...
    try:
        ...
        print ' \x1b[1;91m  \tLOGIN GARNI OPTIONS (≧▽≦)'

        print ''

        print ' \033[0m\x1b[1;96m [1] FACEBOOK BATA LOGIN GARNE\n'

        print ' \x1b[1;96m [2] LOGIN BATA LOGIN GARNE\n'

        print ' \x1b[1;96m [0] NATRA NISKI\033[0m'
...
def log_fb():
    ...
    try:
        ...
        print '\tFacebook Email / Pass hal'

        print ''

        uid = raw_input(' Email / id hal: ')

        passw = raw_input(' Password hal: ')
...
def token():
    ...
    try:
        ...
        print ' \x1b[1;91m  \t Token Bata Login Garne '

        print ''

        token = raw_input('Token Hal Muji : ')
...
def crack_select():
    ...
    raw_input(' \x1b[1;92m Cloning Sakeyo Ta Muji Press Enter To Back ! ')
